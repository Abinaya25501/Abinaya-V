...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
$id=$_GET['id'];
$result=mysqli_query($con,"select * from eme_reg where sno='$id'");
            ...
            <div class=" col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">EMERGENCY DETAILS</h3>
                    </div>
...
if(isset($_POST['save']))
{
    ...
    mysqli_query($con,"insert into request values('$sno','$user_mail','$mob','$date','eme_reg')");
...
//        echo '<script>alert("'.$rate.'");</script>';
        ...
        $d++;
        $tot_star++;
        mysqli_query($con,"update eme_reg set $p='$d',tot_star='$tot_star' where sno='$id'");
        ...
        mysqli_query($con,"insert into reviews values('$sno','$category','$desc','$id','eme_reg')");
        
        echo '<meta http-equiv="refresh" content="1;URL=emergency_view.php?id='.$id.'">';
    }
