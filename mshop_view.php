...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
$id=$_GET['id'];
$result=mysqli_query($con,"select * from mshop_reg where sno='$id'");
            ...
            <div class="col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">MECHANICSHOP DETAIL</h3>
                    </div>
...
if(isset($_POST['save']))
{
    ...
    mysqli_query($con,"insert into request values('$sno','$user_mail','$mob','$date','mshop_reg')");
...
//        echo '<script>alert("'.$rate.'");</script>';
        ...
        $d++;
        $tot_star++;
        mysqli_query($con,"update mshop_reg set $p='$d',tot_star='$tot_star' where sno='$id'");
        ...
        mysqli_query($con,"insert into reviews values('$sno','$category','$desc','$id','mshop_reg')");
        
        echo '<meta http-equiv="refresh" content="1;URL=mshop_view.php?id='.$id.'">';
    }
