...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
$id=$_GET['id'];
$result=mysqli_query($con,"select * from hospital_reg where sno='$id'");
...
?>
                    ...
                    <div class="panel-body" style="border:1px solid #FFA500;border-top:0;">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <img src="<?php echo $img1; ?>" style="height:250px;width:100%;" id="b2"><br><br>
                                </div>
        ...
        for($i=0;$i<=5;$i++)
        {
            if($spe[$i]!="")
            {
               echo'  <input type="checkbox" class="" id="inputEmail3" name="sp[]" value="'.$spe[$i].'" checked  >&nbsp;&nbsp;'.$spe[$i].'<br>';
            }
        }
        ?>
...
if(isset($_POST['save']))
{
    ...
    mysqli_query($con,"insert into request values('$sno','$user_mail','$mob','$date','hospital_reg')");
...
//        echo '<script>alert("'.$rate.'");</script>';
        ...
        $d++;
        $tot_star++;
        mysqli_query($con,"update hospital_reg set $p='$d',tot_star='$tot_star' where sno='$id'");
        ...
        mysqli_query($con,"insert into reviews values('$sno','$category','$desc','$id','hospital_reg')");
        
        echo '<meta http-equiv="refresh" content="1;URL=hospital_view.php?id='.$id.'">';
    }
