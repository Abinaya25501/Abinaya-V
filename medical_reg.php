            ...
            <div class="col-md-offset-3  col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">MEDICAL REGISTRATION</h3>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text" id="inputEmail3"
                                        placeholder="First Name" name="sname">
                                </div>
                            </div>
                            <div class="form-group">
...
if(isset($_POST['d_save']))
{
   ...
   $pwd=$_POST['pwd'];
    ...
    mysqli_query($con,"insert into medical_reg values('$sno','$sname','$ad1','$ad2','$city','$dt','$ot','$cno','$regno','$email','$pwd','$img','$aimg','0','0','0','0','0','0')");
