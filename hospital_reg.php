...
<body>
            ...
            <div class="col-md-offset-3  col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">HOSPITAL REGISTRATION</h3>
                    </div>
                    <div class="panel-body" style="border:1px solid #FFA500;border-top:0;">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Hospital Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text" id="inputEmail3"
                                        placeholder="Hospital Name" name="hname">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Specialist</label>
                                <div class="col-sm-9">
                                    <input type="checkbox" class="" id="inputEmail3" name="sp[]"
                                        value="Baby Specialist">&nbsp;&nbsp;Baby Specialist<br>
                                    <input type="checkbox" class="" id="inputEmail3" name="sp[]"
                                        value="Rheumatologist">&nbsp;&nbsp;Rheumatologist<br>
                                    <input type="checkbox" class="" id="inputEmail3" name="sp[]"
                                        value="Cardioligist">&nbsp;&nbsp;Cardioligist<br>
                                    <input type="checkbox" class="" id="inputEmail3" name="sp[]"
                                        value="Oncologist">&nbsp;&nbsp;Oncologist<br>
                                    <input type="checkbox" class="" id="inputEmail3" name="sp[]"
                                        value="Kephrologist">&nbsp;&nbsp;Kephrologist<br>
                                    <input type="checkbox" class="" id="inputEmail3" name="sp[]"
                                        value="General Speciallist">&nbsp;&nbsp;General Speciallist<br>
                                </div>
                            </div>
    ...
    <?php
$spe[0]=$spe[1]=$spe[2]=$spe[3]=$spe[4]=$spe[5]=""; 
...
//     echo '<script>alert("jhgd");</script>';
    
    
    
if(!empty($_POST['sp'])){
$i=0;
foreach($_POST['sp'] as $selected)
{
    $spe[$i]=$selected;
     $i++;
//    echo '<script>alert("hdfgf");</script>';
}
//    echo $spe1;
//    echo $spe2;
//    echo $spe3;
...
//    echo $spe6;
    ...
    $sno=0;
    $result=mysqli_query($con,"select * from hospital_reg");
    $sno=mysqli_num_rows($result);
    $sno++;
    
    mysqli_query($con,"insert into hospital_reg values('$sno','$hname','$spe[0]','$spe[1]','$spe[2]','$spe[3]','$spe[4]','$spe[5]','$ad1','$ad2','$city','$dt','$time','$regno','$cno','$email','$pwd','$img','$aimg','0','0','0','0','0','0')");
