...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
$id=$_GET['id'];
$result=mysqli_query($con,"select * from medical_reg where sno='$id'");
            ...
            <div class="col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">MEDICAL DETAIL</h3>
                    </div>
                    <div class="panel-body" style="border:1px solid #FFA500;border-top:0;">
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Shop Reg Id</label>
                                <div class="col-sm-9">
...
if(isset($_POST['save']))
{
    ...
    mysqli_query($con,"insert into request values('$sno','$user_mail','$mob','$date','medical_reg')");
...
//        echo '<script>alert("'.$rate.'");</script>';
        ...
        $d++;
        $tot_star++;
        mysqli_query($con,"update medical_reg set $p='$d',tot_star='$tot_star' where sno='$id'");
        ...
        mysqli_query($con,"insert into reviews values('$sno','$category','$desc','$id','medical_reg')");
        
        echo '<meta http-equiv="refresh" content="1;URL=medical_view.php?id='.$id.'">';
    }
...
if(isset($_POST['d_save']))
{
   ...
   $pwd=$_POST['pwd'];
    ...
    $sno=0;
    $result=mysqli_query($con,"select * from medical_reg");
    $sno=mysqli_num_rows($result);
    $sno++;
                                   
    
    mysqli_query($con,"insert into medical_reg values('$sno','$sname','$ad1','$ad2','$city','$dt','$ot','$regno','$email','$pwd','$img','$aimg')");
