...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
$id=$_GET['id'];
$result=mysqli_query($con,"select * from rest_reg where sno='$id'");
            ...
            <div class=" col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">RESTARUANT DETAIL</h3>
                    </div>
                    <div class="panel-body" style="border:1px solid #FFA500;border-top:0;">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Restaruant Name</label>
                                <div class="col-sm-9">
                                    <h4><?php echo $name; ?></h4>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Restaruant Type</label>
                                <div class="col-sm-9">
                                    <?php
        if($type=="Veg")
          echo '  <h4>Vegetarian</h4>';
         else if($type=="Non-Veg")
          echo '  <h4>Non-Vegetarian</h4>';
         else if($type=="Both")
          echo '  <h4>Vegetarian & Non-Vegetarian</h4>';
        ?>
                                </div>
                            </div>
...
if(isset($_POST['save']))
{
    ...
    mysqli_query($con,"insert into request values('$sno','$user_mail','$mob','$date','rest_reg')");
...
//        echo '<script>alert("'.$rate.'");</script>';
        ...
        $d++;
        $tot_star++;
        mysqli_query($con,"update rest_reg set $p='$d',tot_star='$tot_star' where sno='$id'");
        ...
        mysqli_query($con,"insert into reviews values('$sno','$category','$desc','$id','rest_reg')");
        
        echo '<meta http-equiv="refresh" content="1;URL=rest_view.php?id='.$id.'">';
    }
...
$pwd=$_POST['pwd'];
    ...
    $sno=0;
    $result=mysqli_query($con,"select * from rest_reg");
    $sno=mysqli_num_rows($result);
    $sno++;
    
    mysqli_query($con,"insert into rest_reg values('$sno','$rname','$type','$ad1','$ad2','$city','$dt','$regno','$cno','$ot','$email','$pwd','$img','$aimg')");
