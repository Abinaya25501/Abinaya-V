            ...
            <div class="col-md-offset-3  col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">RESTARUANT REGISTRATION</h3>
                    </div>
                    <div class="panel-body" style="border:1px solid #FFA500;border-top:0;">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text" id="inputEmail3"
                                        placeholder="Restaruant Name" name="rname">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="radio" class="" id="inputEmail3" name="type"
                                        value="Veg">&nbsp;&nbsp;Veg &nbsp;&nbsp;
                                    <input type="radio" class="" id="inputEmail3" name="type"
...
$pwd=$_POST['pwd'];
    ...
    mysqli_query($con,"insert into rest_reg values('$sno','$rname','$type','$ad1','$ad2','$city','$dt','$regno','$cno','$ot','$email','$pwd','$img','$aimg','0','0','0','0','0','0')");
