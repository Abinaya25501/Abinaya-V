            ...
            <div class="col-md-offset-3  col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading" style="background-color:#FFA500;">
                        <h3 class="panel-title">EMERGENCY REGISTRATION</h3>
                    </div>
...
$pwd=$_POST['pwd'];
    ...
    $sno=0;
    $result=mysqli_query($con,"select * from eme_reg");
    $sno=mysqli_num_rows($result);
    $sno++;
    
    mysqli_query($con,"insert into eme_reg values('$sno','$name','$ad1','$ad2','$city','$dt','$regno','$cno','$ot','$email','$pwd','$img','$aimg','0','0','0','0','0','0')");
